...
co = cohere.ClientV2(api_key='vH7UqgSnsDeVzoUKmzksGCNTNp9fGIM8U5khqW7x')
...
def retrieve(query: str, doc_id: str, k: int = 5) -> list[str]:
    ...
    result = lib.query(query_texts=query, query_embeddings=embed_q, n_results=20)
    docs = result["documents"][0]
    d = [{"text": doc} for doc in docs]
    ...
    return [docs[doc.index] for doc in rerank_response.results]
